...
public class Metrics {
    ...
    public void registerEvent(@Observes StartupEvent se) {
        ...
        FlightRecorder.register(DatabaseRWInvocationEvent.class);
    }
        ...
        try {
            ...
            recordingStream.onEvent(DatabaseRWInvocationEvent.NAME, event -> {
                ...
                if (rst != null) {
                    ...
                    // ここでスタックトレースをチェックするようにすると負荷発生時に絶妙な遅さになる
                    System.out.println("Check RecordedFrames for the load testing");
